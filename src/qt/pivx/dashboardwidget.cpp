    ...
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelMessage->setText(tr("Amount of EZPAY earned via Staking & Masternodes"));
    ...
    ui->labelAmountPiv->setText("0 EZPAY");
	ui->labelAmountMNRewards->setText("0 EZPAY");
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair EZPAY, zEZPAY
