...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter EZPAY address (e.g. %1)").arg("7mphVWRT43hdZ9zncvPRgA94tuL2dvFXCL"));
...
{
    // return if URI is not valid or is no EZPAY: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Ezpayza.lnk";
}
